...
public class Old_ModuleAdapter extends RecyclerView.Adapter<Old_ModuleAdapter.MyViewHolder> {
    ...
    public Old_ModuleAdapter(Context mContext, List<Module> moduleList){
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
         //       .inflate(R.layout.module_card, parent, false);
                  .inflate(R.layout.course_tabitem, parent, false);
