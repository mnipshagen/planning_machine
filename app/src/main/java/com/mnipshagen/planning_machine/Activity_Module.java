...
public class Activity_Module extends Activity_Base {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int comp_credits = intent.getIntExtra("compECTS", 0);
        // to complete the optional compulsory part
        int optcomp_credits = intent.getIntExtra("optcompECTS", 0);
        // how many credits have been achieved
        int achv_credits = intent.getIntExtra("ECTS", 0);
        // and how many are enrolled
        int ip_credits = intent.getIntExtra("ipECTS", 0);
